...
const chainId = 1337;
// const web3 = new Web3Quorum(new Web3(besu.member1.url));
const web3 = new Web3Quorum(new Web3(besu.member1.url));
...
function getPrivateNonce(account) {
  console.log('PG: ',web3.utils.generatePrivacyGroup(privacyOptions));
...
module.exports = async () => {
  const sender = "0x13a52aab892e1322e8b52506276363d4754c122e";
  ...
  console.log('publicNonce', publicNonce);
